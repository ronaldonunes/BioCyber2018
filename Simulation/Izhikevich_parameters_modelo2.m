%% izhikevich_parameters_model2
% 
%  Set the parameters for model 2[1]
%
%% Syntax
%
%  [N,Ne,Ni,pesos,qtd,D,inputExt,parameters]=Izhikevich_parameters_modelo2(qtd_ex,W_ex)  
%
%% Arguments
%
%    Input:
...
%% Description
%
%   This function sets the parameters for simulation of model 2 [1,2].
%
...
function [N,Ne,Ni,pesos,qtd,D,inputExt,parameters]=Izhikevich_parameters_modelo2(qtd_ex,W_ex)     
    %% General parameters
    ...
    % Synaptic  Weight Network 1 -> Network 2
    pesos.Rede(2,1).EE=0.0;
    pesos.Rede(2,1).EI=W_ex;
    pesos.Rede(2,1).IE=0.0;
    pesos.Rede(2,1).II=0.0;

    % Number of connections Network 1 -> Network 2
    qtd.Rede(2,1).EE=0; 
    qtd.Rede(2,1).EI=qtd_ex; 
    qtd.Rede(2,1).IE=0;
    qtd.Rede(2,1).II=0; 

    % Synaptic  Weight Network 2 -> Network 3
    pesos.Rede(3,2).EE=W_ex;
    pesos.Rede(3,2).EI=0.0;
    pesos.Rede(3,2).IE=0.0;
    pesos.Rede(3,2).II=0.0;

    % Number of connections Network 2 -> Network 3
    qtd.Rede(3,2).EE=qtd_ex; 
    qtd.Rede(3,2).EI=0; 
    qtd.Rede(3,2).IE=0; 
    qtd.Rede(3,2).II=0; 

    % Synaptic  Weight Network 3 -> Network 4
    pesos.Rede(4,3).EE=0.0;
    pesos.Rede(4,3).EI=W_ex;
    pesos.Rede(4,3).IE=0.0;
    pesos.Rede(4,3).II=0.0;

    % Number of connections Network 3 -> Network 4
    qtd.Rede(4,3).EE=0; 
    qtd.Rede(4,3).EI=qtd_ex; 
    qtd.Rede(4,3).IE=0; 
    qtd.Rede(4,3).II=0; 

    % Synaptic  Weight Network 4 -> Network 5
    pesos.Rede(5,4).EE=0.0;
    pesos.Rede(5,4).EI=W_ex;
    pesos.Rede(5,4).IE=0.0;
    pesos.Rede(5,4).II=0.0;

    % Number of connections Network 4 -> Network 5
    qtd.Rede(5,4).EE=0;  
    qtd.Rede(5,4).EI=qtd_ex;
    qtd.Rede(5,4).IE=0; 
    qtd.Rede(5,4).II=0; 

    % Synaptic  Weight Network 5 -> Network 4
    pesos.Rede(4,5).EE=W_ex;
    pesos.Rede(4,5).EI=0.0;
    pesos.Rede(4,5).IE=0.0;
    pesos.Rede(4,5).II=0.0;

    % Number of connections Network 5 -> Network 4
    qtd.Rede(4,5).EE=qtd_ex;  
    qtd.Rede(4,5).EI=0; 
    qtd.Rede(4,5).IE=0;
    qtd.Rede(4,5).II=0; 

    % Synaptic  Weight Network 5 -> Network 1
    pesos.Rede(1,5).EE=W_ex;
    pesos.Rede(1,5).EI=0.0;
    pesos.Rede(1,5).IE=0.0;
    pesos.Rede(1,5).II=0.0;

    % Number of connections Network 5 -> Network 1
    qtd.Rede(1,5).EE=qtd_ex; 
    qtd.Rede(1,5).EI=0; 
    qtd.Rede(1,5).IE=0; 
    qtd.Rede(1,5).II=0; 
