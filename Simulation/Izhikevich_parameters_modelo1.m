%% izhikevich_parameters_model1
% 
%  Set the parameters for model 1[1]
%
%% Syntax
%
%  [N,Ne,Ni,pesos,qtd,D,inputExt,parameters]=Izhikevich_parameters_modelo1(qtd_ex,W_ex)  
%
%% Arguments
%
%    Input:
...
%% Description
%
%   This function sets the parameters for simulation of model 1 [1,2].
%
...
function [N,Ne,Ni,pesos,qtd,D,inputExt,parameters]=Izhikevich_parameters_modelo1(qtd_ex,W_ex)     
    %% General parameters
    ...
    pesos.Rede(2,1).EE=W_ex;
    pesos.Rede(2,1).EI=0.0;
    pesos.Rede(2,1).IE=0.0;
    pesos.Rede(2,1).II=0.0;

    % Number of connections Network 1 -> Network 2
    qtd.Rede(2,1).EE=qtd_ex;
    qtd.Rede(2,1).EI=0;
    qtd.Rede(2,1).IE=0; 
    qtd.Rede(2,1).II=0; 

    % Synaptic  Weight Network 1 -> Network 3
    pesos.Rede(3,1).EE=0.0;
    pesos.Rede(3,1).EI=W_ex;
    pesos.Rede(3,1).IE=0.0;
    pesos.Rede(3,1).II=0.0;

    % Number of connections Network 1 -> Network 3
    qtd.Rede(3,1).EE=0; 
    qtd.Rede(3,1).EI=qtd_ex; 
    qtd.Rede(3,1).IE=0; 
    qtd.Rede(3,1).II=0; 

    % Synaptic  Weight Network 1 -> Network 4
    pesos.Rede(4,1).EE=0.0;
    pesos.Rede(4,1).EI=W_ex;
    pesos.Rede(4,1).IE=0.0;
    pesos.Rede(4,1).II=0.0;

    % Number of connections Network 1 -> Network 4
    qtd.Rede(4,1).EE=0;  
    qtd.Rede(4,1).EI=qtd_ex; 
    qtd.Rede(4,1).IE=0; 
    qtd.Rede(4,1).II=0; 
